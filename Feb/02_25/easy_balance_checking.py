...
On each line of the report you have to add the new balance and then in the last 
two lines the total expense and the average expense. So as not to have a too long 
result string we don't ask for a properly formatted result.
...
if __name__ == '__main__':
    ...
    if doctest.testmod().failed == 0: 
        print('\n You got it all in check. Good job! \n')
